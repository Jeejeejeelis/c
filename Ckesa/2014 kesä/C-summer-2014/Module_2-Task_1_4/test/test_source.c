...
int main(int argc, const char *argv[]) {
    ...
    Suite *s = suite_create("Test-2.1-4");

    /* TODO: define tests */
    tmc_register_test(s, test_number_swap, "2.1");
    tmc_register_test(s, test_array_sum, "2.2");
    tmc_register_test(s, test_array_reader, "2.3");
    tmc_register_test(s, test_largest_num, "2.4");
